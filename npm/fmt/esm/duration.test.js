...
test("fmt::duration formats narrow, full, and digital output", () => {
    ...
    equal(format(99_674, { style: "full", ignoreZero: true }), "1 minute, 39 seconds, 674 milliseconds");
...
test("fmt::duration rejects an invalid style", () => {
    throws(() => format(1, { style: "invalid" }), TypeError, 'style must be "narrow", "full", or "digital"!');
});
