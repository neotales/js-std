...
test("exists follows generated file and directory links for async and sync calls", {
    skip: isWindows,
}, async () => {
    await withTestRoot(async (root) => {
        const file = join(root, "file");
...
test("exists reports mode-000 files, directories, and links as unreadable", {
...
test("existsSync reports mode-000 files, directories, and links as unreadable", {
    skip: isWindows || uid() === 0,
}, () => {
    withTestRootSync((root) => {
        const file = join(root, "file");
