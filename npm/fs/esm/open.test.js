...
test("open applies the requested mode after umask when creating a generated file", { skip: isWindows }, async () => {
    await withTestRoot(async (root) => {
        const file = join(root, "file");
...
test("openSync applies the requested mode after umask when creating a generated file", {
    skip: isWindows,
}, () => {
    withTestRootSync((root) => {
        const file = join(root, "file");
