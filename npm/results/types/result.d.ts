...
export declare class ResultError extends Error {
    ...
    constructor(message?: string, options?: ResultErrorOptions);
}
/**
...
export declare class Result<T, E = Error> {
     ...
     * ```
     */
    toPromise<U>(onFulfilled: (value: T) => U | PromiseLike<U>, onRejected?: (error: E) => U | PromiseLike<U>): Promise<U>;
    /**
     ...
     * ```
     */
    toPromise<U>(onFulfilled: undefined, onRejected: (error: E) => U | PromiseLike<U>): Promise<T | U>;
    /**
 ...
 * ```
 */
export declare class EmptyResult<E = Error> extends Result<void, E> {
     ...
     * ```
     */
    static tryCatchAsync(fn: () => Promise<void>): Promise<EmptyResult<Error>>;
}
/**
 * A failed `Result`.
 *
 ...
 * ```
 */
export declare class Failure<E = Error> extends Result<never, E> {
 ...
 * ```
 */
export declare function empty<E = never>(): EmptyResult<E>;
/**
 ...
 * ```
 */
export declare function fromNullable<T, E>(value: T, error: E | (() => E)): Result<NonNullable<T>, E>;
/**
 ...
 * ```
 */
export declare function fromPredicate<T, E>(value: T, predicate: (value: T) => boolean, error: E | (() => E)): Result<T, E>;
/**
 ...
 * ```
 */
export declare function all<T, E>(results: Iterable<Result<T, E>>): Result<T[], E>;
/**
 ...
 * ```
 */
export declare function allAsync<T, E>(results: Iterable<PromiseLike<Result<T, E>>>): Promise<Result<T[], E>>;
/**
 ...
 * ```
 */
export declare function failAsError<T = never>(error: unknown): Result<T, Error>;
/**
 ...
 * ```
 */
export declare function match<T, E, U>(result: Result<T, E>, onOk: (value: T) => U, onError: (error: E) => U): U;
/**
 ...
 * ```
 */
export declare function tryCatch<T>(fn: () => T, onRejected?: (error: unknown) => Error): Result<T, Error>;
/**
 ...
 * ```
 */
export declare function tryCatchAsync<T>(fn: () => T | PromiseLike<T>, onRejected?: (error: unknown) => Error): Promise<Result<Awaited<T>, Error>>;
export {};
