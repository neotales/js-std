 ...
 */
export declare function mkdir(path: string | URL, options?: MkdirOptions): Promise<void>;
/**
 ...
 * @param options Options for creating directories.
 */
export declare function mkdirSync(path: string | URL, options?: MkdirOptions): void;
