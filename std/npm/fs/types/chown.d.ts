 ...
 */
export declare function chown(path: string | URL, uid: number | null, gid: number | null): Promise<void>;
/**
 ...
 * @param gid The group id (GID) of the new owner, or `null` for no change.
 */
export declare function chownSync(path: string | URL, uid: number | null, gid: number | null): void;
