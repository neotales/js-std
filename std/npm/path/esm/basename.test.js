...
test("path::posix.basename() throws with non-file URL", () => {
    throws(() => posixUnstableBasename(new URL("https://deno.land/")), TypeError, 'URL must be a file URL: received "https:"');
...
test("path::windows.basename() throws with non-file URL", () => {
    ...
    throws(() => windowsUnstableBasename(new URL("https://deno.land/")), TypeError, 'URL must be a file URL: received "https:"');
});
