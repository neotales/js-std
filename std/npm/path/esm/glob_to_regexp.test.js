...
function equalRegExp(actual, expected) {
...
test("path::globToRegExp() checks complex matches", () => {
    ...
    ok(!match("http://?o[oz].b*z.com/{*.js,*.html}", "http://moz.buzz.com/index.htm", {
        extended: false,
        globstar: false,
    }));
    ok(!match("http://?o[oz].b*z.com/{*.js,*.html}", "http://moz.bar.com/index.html", {
        extended: false,
        globstar: false,
    }));
    ok(!match("http://?o[oz].b*z.com/{*.js,*.html}", "http://flozz.buzz.com/index.html", {
        extended: false,
        globstar: false,
    }));
});
