...
test("process::args", () => {
    if (DENO) {
        const o = spawnSync(deno, ["run", "-A", `${dir}/internal/args.ts`, "arg1", "arg2", "--option", "value", "-o"], {
            encoding: "utf-8",
            stdio: "pipe",
        });
    ...
    if (NODE) {
        const o = spawnSync(node, ["--input-type=module", "--eval", argsScript, "arg1", "arg2", "--option", "value", "-o"], {
            cwd: dir,
            encoding: "utf-8",
            stdio: "pipe",
        });
