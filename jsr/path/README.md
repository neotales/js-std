...
| ---------- | ---- | ------- | --- | -------- | ------------------ | ---------- | -------- | ----------- | ----------- |
| Supported  | Yes  | Yes     | Yes | Yes      | Yes                | Partial    | Yes      | Partial     | Partial     |

String operations run everywhere. URL conversion and working-directory calls need a host `URL` or process global.
