...
/* copy file to dest */
async function cpf(src: string | URL, dest: string | URL, options: InternalCopyOptions) {
...
function cpfSync(src: string | URL, dest: string | URL, options: InternalCopyOptions) {
